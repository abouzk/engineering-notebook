...
> **Engineering Log:** [Link to notebook entry]
...
[One high-level pipeline or block diagram showing the full system, mermaid, the first thing a technical reader looks at.]

``mermaid
[diagram here]
``

> **Detailed architecture diagrams:** [Link to docs/architecture.md]
